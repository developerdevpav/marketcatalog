...
@Service
open class ProductValueService(
    ...
    open fun save(entity: AbstractCharacteristic<Any>): AbstractCharacteristic<Any>? {
        ...
        characteristicUUID
            ?: throw DatabaseRequestInNotValidThrowable("Characteristic entity must contain an id is not null")
        ...
        dataType
            ?: throw EntityNotFoundException("Characteristic with ID $characteristicUUID doesn't contain DATA TYPE")
        ...
        return when (dataType.name) {
            Constant.DataType.Double -> {
                ...
                val valueDoubleUnion = buildValueUnion(
                    entity.value as Double, characteristic,
            ...
            Constant.DataType.String -> {
                ...
                var stringCharacteristic =
                    stringSingleCharacteristicService.save(valueStringUnion as StringCharacteristic)
                return null
            }
    ...
    private fun <T> buildValueUnion(
        value: T, characteristic: Characteristic,
